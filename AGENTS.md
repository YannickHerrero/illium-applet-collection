...
- Never modify the sibling Illium repository for collection tasks.
...
- Keep private runtime data, caches and backups outside the repository and outside Illium's watched configuration tree.
